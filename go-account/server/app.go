...
import (
	...
	"github.com/kaleemubarok/gc-ref/go-account/usecase/profile"
	"github.com/kaleemubarok/gc-ref/go-account/usecase/userauth"
	_ "github.com/lib/pq"
...
var profileUsecase profile.IUsecase
...
func main() {
	...
	profileUsecase = profile.NewUsecase(dbResource, configuration)
...
func getUserInfo(c *gin.Context) {
	...
	user, err := profileUsecase.GetUserByUserID(userID)
	if err != nil {
